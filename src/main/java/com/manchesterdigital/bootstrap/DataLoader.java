...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void addPancakeRecipeToRecipeRepository() {
        ...
        pancakes.addIngredient(new Ingredient("flour", new BigDecimal(2), cup))
                .addIngredient(new Ingredient("baking powder", new BigDecimal(2), teaspoon))
                .addIngredient(new Ingredient("sugar", new BigDecimal(1), tablespoon))
                .addIngredient(new Ingredient("salt", new BigDecimal(1), pinch))
                .addIngredient(new Ingredient("eggs", new BigDecimal(2), whole))
                .addIngredient(new Ingredient("milk", new BigDecimal(200), millilitres))
